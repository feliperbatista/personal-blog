...
export default function Header() {
  return (
    <header className="lg:h-screen sm:h-50 flex justify-center items-center flex-col row-span-3 lg:sticky top-0">
      <div className="px-10">
        <div className="lg:flex md:hidden sm:hidden justify-center gap-3">
          <Link
            href="#about"
            className="text-title font-noto transition hover:text-highlight"
          >
            Sobre
          </Link>
        ...
        <h3
          className="font-montserrat text-text lg:mb-56 sm:mb-20 sm:w-44 lg:w-auto"
          id="description"
        >
          Engenheiro Químico. Dev em construção. Curioso.
        </h3>
